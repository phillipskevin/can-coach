# Contributing to can-devtools-poc

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/phillipskevin/can-devtools-poc) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-devtools-poc, you can start by going to its [fork page](https://github.com/phillipskevin/can-devtools-poc/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-devtools-poc
```
